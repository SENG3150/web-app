...
angular
    .module('joy-global')
    .controller('AdministratorModelsControllerView', ['$scope', 'LayoutService', '$state', 'DataTablesService', 'Models', '$stateParams', function ($scope, LayoutService, $state, DataTablesService, Models, $stateParams) {
