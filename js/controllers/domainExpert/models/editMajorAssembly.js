...
angular
    .module('joy-global')
    .controller('DomainExpertModelsControllerEditMajorAssembly', ['$scope', 'LayoutService', '$state', 'DataTablesService', 'MajorAssemblies', '$stateParams', 'toastr', function ($scope, LayoutService, $state, DataTablesService, MajorAssemblies, $stateParams, toastr) {
        ...
        LayoutService.getPageHeader().setBreadcrumbs([
            ...
            {
                route: 'domainExpert-models-EditMajorAssembly',
